...
In this program the user decides which operation they would like to complete as
many time as they'd like. They can also have the option to quit out of the
program
